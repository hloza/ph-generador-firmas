...
<div class="max-w-4xl mx-auto">
  ...
  <div class="text-center mb-8">
    <div class="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl mb-4 shadow-lg shadow-purple-500/25">
      <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
      </svg>
    </div>
    <h1 class="text-3xl font-bold gradient-text mb-2">Redes Sociales</h1>
    <p class="text-lg text-slate-400">Conecta tus perfiles sociales profesionales (opcional)</p>
  </div>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div class="dark-card p-8">
      <h2 class="text-xl font-semibold text-slate-200 mb-6">Perfiles Sociales</h2>
      
      <div class="space-y-6">
        <!-- LinkedIn -->
        <div>
          <label for="linkedin" class="flex items-center text-sm font-medium text-slate-300 mb-2">
        ...
        <!-- Twitter -->
        <div>
          <label for="twitter" class="flex items-center text-sm font-medium text-slate-300 mb-2">
          ...
          <input
            ...
            class="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-lg text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent"
          />
        </div>

        <!-- GitHub -->
        <div>
          <label for="github" class="flex items-center text-sm font-medium text-slate-300 mb-2">
          ...
          <input
            ...
            class="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-lg text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent"
          />
        </div>

        <!-- Instagram -->
        <div>
          <label for="instagram" class="flex items-center text-sm font-medium text-slate-300 mb-2">
          ...
          <input
            ...
            class="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-lg text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
          />
        </div>
      </div>
      ...
      <div class="mt-8 p-4 bg-slate-700/30 border border-slate-600/30 rounded-lg">
        <h3 class="text-sm font-medium text-slate-300 mb-2">⚡ Paso Opcional</h3>
    ...
    <div class="dark-card p-8">
      ...
      <div class="preview-section">
            ...
            {#if hasAnySocial}
              <div class="mt-4 pt-3 border-t border-gray-200">
                <div class="flex space-x-3">
                  ...
                  {#if formData.twitter}
                    <div class="w-6 h-6 bg-sky-500 rounded flex items-center justify-center">
                      <svg class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                      </svg>
                    </div>
        ...
        <div class="mt-4 text-sm text-slate-400">
          <p>Los iconos de redes sociales aparecerán según los enlaces que agregues.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="flex justify-between items-center mt-8 pt-6 border-t border-slate-700">
    ...
    <button
      ...
      class="flex items-center px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-semibold rounded-lg transition-all duration-300"
    >
      Continuar
